#ifndef LOBCALCDUMMY_IMPL_BASE_H
#define LOBCALCDUMMY_IMPL_BASE_H
...
class lobCalcDummy_base : public Resource_impl
{
    public:
        lobCalcDummy_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<lobCalcDummy_base> *serviceThread; 
        boost::mutex serviceThreadLock;

        // Member variables exposed as properties
        short lob;
        bool valid;
        short packetsBeforeChange;
