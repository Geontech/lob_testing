#ifndef PSEUDODOPPLERSIM_IMPL_BASE_H
#define PSEUDODOPPLERSIM_IMPL_BASE_H
...
class pseudoDopplerSim_base : public Resource_impl
{
    public:
        pseudoDopplerSim_base(const char *uuid, const char *label);
    ...
    protected:
        ProcessThread<pseudoDopplerSim_base> *serviceThread; 
